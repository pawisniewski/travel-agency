...
describe('Component OrderOption', () => {
  ...
  it('should render without crashing', () => {
    const component = shallow(<OrderOption name='car rental' type='dropdown' />);
  ...
  it('should display "name" prop in title', () => {
    const component = shallow(<OrderOption name='car rental' type='dropdown' />);
    expect(component.find('.title').text()).toEqual('car rental');
  });
});
    ...
    switch (type) {
      ...
      case 'icons': {
        ...
        it('contains div with icons', () => {
          const mainDiv = renderedSubcomponent.find('div').at(0);
